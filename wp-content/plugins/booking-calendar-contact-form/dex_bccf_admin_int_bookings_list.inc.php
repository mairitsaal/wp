...
<form action="admin.php" method="get">
 ...
 From: <input type="text" id="dfrom" name="dfrom" value="<?php echo esc_attr(sanitize_text_field($_GET["dfrom"])); ?>" /> &nbsp; &nbsp; &nbsp; 
 To: <input type="text" id="dto" name="dto" value="<?php echo esc_attr(sanitize_text_field($_GET["dto"])); ?>" /> &nbsp; &nbsp; &nbsp; 
