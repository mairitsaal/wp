...
<input name="dex_item" type="hidden" value="<?php echo CP_BCCF_CALENDAR_ID; ?>" />
...
<?php } else { ?>
   ...
   <div id="bccfcaladmin"><div id="cal<?php echo CP_BCCF_CALENDAR_ID; ?>" class="rcalendar"><span style="color:#009900">Loading calendar data...</span></em></div></div>
   ...
   <script type="text/javascript">
    ...
    (function($) {   
        ...
        $calendarjQuery("#cal<?php echo CP_BCCF_CALENDAR_ID; ?>").rcalendar({"calendarId":<?php echo CP_BCCF_CALENDAR_ID; ?>,
                                            ...
                                            "defaultSaveColor":'<?php echo dex_bccf_get_option('calendar_defrcolor',TDE_BCCFCALENDAR_DEFAULT_SELCOLOR); ?>',
                                            "edition":true,
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <th scope="row">Enable Paypal Payments?</th>
         ...
         <em>* PayPal is required in this free version since the form is processed on the PayPal IPN notification. For other versions without PayPal payments or with optional PayPal payment for the customer please check the <a href="https://bccf.dwbooster.com">plugin's page</a>.</em>
        </td>
        </tr>
...
<script type="text/javascript">
 ...
 $j(function() {
  ...
  $j('#dex_noseasons_availmsg').load('<?php echo cp_bccf_get_site_url(true); ?>/?dex_bccf=loadseasonprices&_wpnonce=<?php echo $nonce_ss; ?>&inAdmin=1&dex_item=<?php echo CP_BCCF_CALENDAR_ID; ?>');
  ...
  {
     $j('#abcmindateval').load('<?php echo cp_bccf_get_site_url(true); ?>/?dex_bccf=bccf_loadmindate&code='+encodeURIComponent(document.getElementById("calendar_mindate").value));
  }
  
  function bccf_checkdatemax()                             
  {
     $j('#abcmaxdateval').load('<?php echo cp_bccf_get_site_url(true); ?>/?dex_bccf=bccf_loadmaxdate&code='+encodeURIComponent(document.getElementById("calendar_maxdate").value)+'&code2='+encodeURIComponent(document.getElementById("calendar_mindate").value));
  }  
  bccf_checkdatemax();
  bccf_checkdatemin();
